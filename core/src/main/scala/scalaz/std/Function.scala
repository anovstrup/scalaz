...
trait FunctionInstances extends FunctionInstances0 {
  ...
  implicit def function0Equal[R: Equal]: Equal[() => R] = new AbstractEqual[() => R] {
  ...
  implicit def function1Covariant[T]: Monad[({type l[a] = (T => a)})#l] with Zip[({type l[a] = (T => a)})#l] with Unzip[({type l[a] = (T => a)})#l] with Distributive[({type l[a] = (T => a)})#l] = new AbstractMonad[({type l[a] = (T => a)})#l] with Zip[({type l[a] = (T => a)})#l] with Unzip[({type l[a] = (T => a)})#l] with Distributive[({type l[a] = (T => a)})#l] {
    def point[A](a: => A) = _ => a
  ...
  implicit def function1Contravariant[R]: Contravariant[({type l[a] = (a => R)})#l] = new AbstractContravariant[({type l[a] = (a => R)})#l] {
    def contramap[A, B](r: A => R)(f: B => A) = r compose f
  }

  implicit def function2Instance[T1, T2]: Monad[({type l[a] = ((T1, T2) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2) => a)})#l] {
    def point[A](a: => A) = (t1, t2) => a

    def bind[A, B](fa: (T1, T2) => A)(f: (A) => (T1, T2) => B) = (t1, t2) => f(fa(t1, t2))(t1, t2)
  }

  implicit def function3Instance[T1, T2, T3]: Monad[({type l[a] = ((T1, T2, T3) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3) => a)})#l] {
    def point[A](a: => A) = (t1, t2, t3) => a

    def bind[A, B](fa: (T1, T2, T3) => A)(f: (A) => (T1, T2, T3) => B) = (t1, t2, t3) => f(fa(t1, t2, t3))(t1, t2, t3)
  }

  implicit def function4Instance[T1, T2, T3, T4]: Monad[({type l[a] = ((T1, T2, T3, T4) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3, T4) => a)})#l] {
    def point[A](a: => A) = (t1, t2, t3, t4) => a

    def bind[A, B](fa: (T1, T2, T3, T4) => A)(f: (A) => (T1, T2, T3, T4) => B) = (t1, t2, t3, t4) => f(fa(t1, t2, t3, t4))(t1, t2, t3, t4)
  }

  implicit def function5Instance[T1, T2, T3, T4, T5]: Monad[({type l[a] = ((T1, T2, T3, T4, T5) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3, T4, T5) => a)})#l] {
  ...
  implicit def function6Instance[T1, T2, T3, T4, T5, T6]: Monad[({type l[a] = ((T1, T2, T3, T4, T5, T6) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3, T4, T5, T6) => a)})#l] {
  ...
  implicit def function7Instance[T1, T2, T3, T4, T5, T6, T7]: Monad[({type l[a] = ((T1, T2, T3, T4, T5, T6, T7) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3, T4, T5, T6, T7) => a)})#l] {
  ...
  implicit def function8Instance[T1, T2, T3, T4, T5, T6, T7, T8]: Monad[({type l[a] = ((T1, T2, T3, T4, T5, T6, T7, T8) => a)})#l] = new AbstractMonad[({type l[a] = ((T1, T2, T3, T4, T5, T6, T7, T8) => a)})#l] {
